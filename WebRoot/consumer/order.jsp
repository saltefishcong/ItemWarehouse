...
<html>
  ...
  <form action="servlet/selectServlet?action=selectordername&type=consumer" method="post"><input type="text" name="seriesorder" /> <input type="submit" value="搜索物品订单纪录"> </form>
         ...
         if(request.getAttribute("order") instanceof String){
          ...
          if(p<comlist.size()+1){
               ...
               if(com.getOrder_id()==or.getId()){
                ...
                comment_text="<a href='/ItemWarehouse/consumer/comment.jsp?orderid=";
                comment_text+=or.getId()+"&store="+or.getStore_name()+"'>";
                comment_text+="点击评价"+"</a>";   
              } 
             }                            
         }else{
