...
<html>
  <head>
    ...
    <title>My JSP 'selectproduce.jsp' starting page</title>
  ...
  <button onclick="window.location='/ItemWarehouse/store/index.jsp'">返回</button>
     <form action="servlet/selectServlet?action=selectproducename&type=store" method="post"><input type="text" name="articlename" /> <input type="submit" value="搜索物品生成纪录"> </form>
